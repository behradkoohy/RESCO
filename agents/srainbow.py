...
from pfrl.agents import CategoricalDQN as DQN
...
class SRainbow(IndependentAgent):
    def __init__(self, config, obs_act, map_name, thread_number):
        ...
        for key in obs_act:
            ...
            #import pdb
            #pdb.set_trace()
            print(key, len(obs_space), act_space)
            model = nn.Sequential(
                ...
                nn.ReLU(),
                nn.Linear(64, 64),
                DistributionalFCStateQFunctionWithDiscreteAction(64, act_space, 100, -10, 10, n_hidden_channels=16, n_hidden_layers=2)
            )
